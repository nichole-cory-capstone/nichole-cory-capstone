    ...
    function setupMarker(inList, place, yelpInfo,otData) {
        ...
        try{
            if(typeof otData.restaurants[0].mobile_reserve_url !== "undefined"){
                openTableUrl =  '<a style="color: #fff;  size=9px;" href="'+ otData.restaurants[0].mobile_reserve_url +'" target="_blank"><img src="/images/ot_logo.png" class="modal-icon" style="width: 55px; height: 45px; margin-right: 15px;"/></a>'
            }
        }catch (e){
            if(e){
                //Boo google
